...
#path_to_frameops = os.path.join(path_to_at_root, "python/daaltk/frame/ops")
#path_to_frame = os.path.join(path_to_at_root, "python/daaltk/frame/frame.py")
#path_to_graphops = os.path.join(path_to_at_root, "python/daaltk/graph/ops")
#path_to_graph = os.path.join(path_to_at_root, "python/daaltk/graph/graph.py")
path_to_models = os.path.join(path_to_at_root, "python/daaltk/models")
path_to_ops = os.path.join(path_to_at_root, "python/daaltk/operations/ops")
path_to_doc = os.path.join(path_to_at_root, "python/daaltk/doc")
...
def filter_exemptions(paths):
    ...
    chop = len(path_to_models) + 1  # the + 1 is for the extra forward slash
...
def main():
    ...
    test_paths = [test_path for folder_path in [path_to_models, path_to_ops] for test_path in get_all_example_file_paths(folder_path)]
